...
```{r facetedscorestime, fig.cap = "Scores over time", fig.width = 8, fig.height = 8, echo = FALSE, message = FALSE, warning = FALSE, out.width = '75%', fig.align = "center"}
cleaned_data %>%
  ...
  scale_x_datetime(breaks = c(as.POSIXct("2020-01-01 00:01 EST"), 
                              as.POSIXct("2020-03-01 01:01 EST"),
                              as.POSIXct("2020-05-01 01:01 EST"),
                              as.POSIXct("2020-07-01 01:01 EST"),
                              as.POSIXct("2020-09-01 01:01 EST"),
                              as.POSIXct("2020-11-01 01:01 EST"),
                              as.POSIXct("2021-01-01 01:01 EST")),
                    minor_breaks = NULL,
                    labels = date_format("%b\n%Y", tz="EST"),  # Format the x-axis scale to show month names
                   # set x-axis limits 
                   limits = as.POSIXct(strptime(c("2019-12-16 00:00", "2021-01-25 00:00"), 
                                                 format = "%Y-%m-%d %H:%M"))
                   ) +
...
cleaned_data %>%
  ...
  knitr::kable(digits = 3,
               col.names = c("Year and Month", "Unique Packages Scored",
                             "Times the Portal was Scored", "Accessibility",
  ...
  # Style the table:
  add_header_above(c("", "Counts" = 2, "Average Scores" = 6)) %>%
  ...
  pack_rows("Manual Scoring", 1, 3) %>%
  pack_rows("Scheduled Scoring", 4, 10) %>%
...
## shown using a color gradient. Lollipop graph uses point and segment.
  ...
  scale_x_datetime(breaks = c(as.POSIXct("2020-01-01 00:01 EST"), # Set breaks on the first of the month
                              as.POSIXct("2020-02-01 01:01 EST"),
                              as.POSIXct("2020-03-01 01:01 EST"),
                              as.POSIXct("2020-04-01 01:01 EST"),
                              as.POSIXct("2020-05-01 01:01 EST"),
                              as.POSIXct("2020-06-01 01:01 EST"),
                              as.POSIXct("2020-07-01 01:01 EST"),
                              as.POSIXct("2020-08-01 01:01 EST"),
                              as.POSIXct("2020-09-01 01:01 EST"),
                              as.POSIXct("2020-10-01 01:01 EST"),
                              as.POSIXct("2020-11-01 01:01 EST"),
                              as.POSIXct("2020-12-01 01:01 EST"),
                              as.POSIXct("2021-01-01 01:01 EST")),
                    minor_breaks = NULL,  # Remove minor break lines
                    labels = date_format("%b\n%Y",tz="EST"),  # Format the x-axis scale to show month names
                    limits = as.POSIXct(strptime(c("2019-12-16 00:00", "2021-01-25 00:00"),  # x-axis limits
                    format = "%Y-%m-%d %H:%M"))) +
  labs(color = "Average \nQuality \nscore \nacross all \npackages",
       x = "Date recorded",
